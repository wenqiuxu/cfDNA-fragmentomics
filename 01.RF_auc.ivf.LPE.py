...
#input feature
gene_list_file = pd.read_table("/data/Extended Data Fig 9/RF.ivf.features.txt", index_col=0, header = None)
...
final_predit = {'criterion': 'gini', 'max_depth': 1, 'min_samples_leaf': 20, 'n_estimators': 200}
...
f = open ('/results/Extended Data Fig 9/model_ivf.LPE.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Extended Data Fig 9/AUC_ivf.LPE.pdf'
#画图
plt.figure()
lw = 2
