...
#input feature
gene_list_file = pd.read_table("/data/Extended Data Fig 9/RF.pmh.features.txt", index_col=0, header = None)
...
final_predit = {'criterion': 'gini', 'max_depth': 1, 'n_estimators': 200}
...
f = open ('/results/Extended Data Fig 9/model_pmh.LPE.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Extended Data Fig 9/AUC_pmh.LPE.pdf'
#画图
plt.figure()
lw = 2
