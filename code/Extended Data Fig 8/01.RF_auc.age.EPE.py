...
#input feature
gene_list_file = pd.read_table("/data/Extended Data Fig 8/RF.age.features.txt", index_col=0, header = None)
...
f = open ('/results/Extended Data Fig 8/model_age.EPE.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Extended Data Fig 8/AUC_age.EPE.pdf'
#画图
plt.figure()
lw = 2
