...
#input feature
gene_list_file = pd.read_table("/data/Extended Data Fig 8/RF.clinic.features.txt", index_col=0, header = None)
...
final_predit = {'criterion': 'entropy', 'max_depth': 7, 'min_samples_leaf': 50, 'n_estimators': 200}
...
f = open ('/results/Extended Data Fig 8/model_clinic.EPE.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Extended Data Fig 8/AUC_clinic.EPE.pdf'
#画图
plt.figure()
lw = 2
