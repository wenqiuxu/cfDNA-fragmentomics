...
data=read.xlsx("/data/Extended Data Fig 1/Extended_data_Figure1.xlsx",sheet=5)
data=na.omit(data)
...
pdf("/results/Extended Data Fig 1/Extended_data_Figure1f.pdf", height=1.85, width=1.71)
