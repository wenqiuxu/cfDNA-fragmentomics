...
gene_list_file_clinic = pd.read_table("/data/Extended Data Fig 10/RF.clinic.features.txt", index_col=0, header = None)
gene_list_clinic = gene_list_file_clinic.index.tolist()
gene_list_file_cfDNA = pd.read_table("/data/Figure5/features.cfDNA.16w.EPE.txt", index_col=0, header = None)
gene_list_cfDNA = gene_list_file_cfDNA.index.tolist()
gene_list_file_combined = pd.read_table("/data/Figure5/RF_EPE.combined.features.txt", index_col=0, header = None)
...
##三个模型
res1 = open('/data/model_EPE/EPE_clinic_16.dat','rb')
s1=res1.read()
clf_clinic=pickle.loads(s1)

res2 = open('/data/model_EPE/EPE_cfDNA_16.dat','rb')
s2=res2.read()
clf_cfDNA=pickle.loads(s2)

res3 = open('/data/model_EPE/EPE_combined_16.dat','rb')
s3=res3.read()
clf_combined=pickle.loads(s3)

###plot AUC
filename1='/results/Extended Data Fig 10/AUC_EPE_16.valid.pdf'
#画图
plt.figure()
lw = 2
...
###plot AUC
filename2='/results/Extended Data Fig 10/AUC_EPE_16.test1.pdf'
#画图
plt.figure()
lw = 2
plt.figure(figsize=(5,5))
...
###plot AUC
filename2='/results/Extended Data Fig 10/AUC_EPE_16.test2.pdf'
#画图
plt.figure()
lw = 2
plt.figure(figsize=(5,5))
