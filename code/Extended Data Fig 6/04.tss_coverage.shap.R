...
##gini
disease=read.table("/data/Extended Data Fig 6/shap.tss_coverage.late_PE.train_valid.txt",header=T,sep="\t",check.names=F,row.names=1)
control=read.table("/data/Extended Data Fig 6/shap.tss_coverage.control.train_valid.txt",header=T,sep="\t",check.names=F,row.names=1)
...
pdf("/results/Extended Data Fig 6/04.shap.tss_coverage.LPE.rf.pdf", height=1.5, width=2.5)
