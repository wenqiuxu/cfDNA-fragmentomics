...
#input feature
gene_list_file = pd.read_table("/data/Figure 5/features.cfDNA.16w.EPE.txt", index_col=0, header = None)
...
model_i_str=str(i)
f = open ('/results/Figure 5/EPE_cfDNA_16/model/EPE_cfDNA_16.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Figure 5/EPE_cfDNA_16/auc/AUC_1.pdf'
#画图
plt.figure()
lw = 2
...
filename2='/results/Figure 5/EPE_cfDNA_16/ppv/train.PPV_CI.csv'
f = open(filename2,'a')
f.write(str(train_ppv)+'\n')
f.close()

filename3='/results/Figure 5/EPE_cfDNA_16/auc/train.AUC_CI.txt'
f = open(filename3,'a')
...
filename4='/results/Figure 5/EPE_cfDNA_16/ppv/val.PPV_CI.csv'
f = open(filename4,'a')
f.write(str(val_ppv)+'\n')
f.close()

filename5='/results/Figure 5/EPE_cfDNA_16/auc/val.AUC_CI.txt'
f = open(filename5,'a')
...
filename6='/results/Figure 5/EPE_cfDNA_16/ppv/test1.PPV_CI.csv'
f = open(filename6,'a')
f.write(str(test1_ppv)+'\n')
f.close()

filename7='/results/Figure 5/EPE_cfDNA_16/auc/test1.AUC_CI.txt'
f = open(filename7,'a')
...
filename8='/results/Figure 5/EPE_cfDNA_16/ppv/test2.PPV_CI.csv'
f = open(filename8,'a')
f.write(str(test2_ppv)+'\n')
f.close()

filename9='/results/Figure 5/EPE_cfDNA_16/auc/test2.AUC_CI.txt'
f = open(filename9,'a')
