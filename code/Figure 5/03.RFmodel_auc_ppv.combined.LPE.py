...
#input feature
gene_list_file = pd.read_table("/data/Figure 5/RF_LPE.combined.features.txt", index_col=0, header = None)
...
final_predit = {'criterion': 'gini', 'max_depth': 14, 'min_samples_leaf': 50, 'n_estimators': 300}
...
f = open ('/results/Figure 5/combined_LPE/model/combined_LPE.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Figure 5/combined_LPE/auc/AUC_1.pdf'
#画图
plt.figure()
lw = 2
...
filename2='/results/Figure 5/combined_LPE/ppv/train.PPV_CI.csv'
f = open(filename2,'a')
f.write(str(train_ppv)+'\n')
f.close()

filename3='/results/Figure 5/combined_LPE/auc/train.AUC_CI.txt'
f = open(filename3,'a')
...
filename4='/results/Figure 5/combined_LPE/ppv/val.PPV_CI.csv'
f = open(filename4,'a')
f.write(str(val_ppv)+'\n')
f.close()

filename5='/results/Figure 5/combined_LPE/auc/val.AUC_CI.txt'
f = open(filename5,'a')
...
filename6='/results/Figure 5/combined_LPE/ppv/test1.PPV_CI.csv'
f = open(filename6,'a')
f.write(str(test1_ppv)+'\n')
f.close()

filename7='/results/Figure 5/combined_LPE/auc/test1.AUC_CI.txt'
f = open(filename7,'a')
...
filename8='/results/Figure 5/combined_LPE/ppv/test2.PPV_CI.csv'
f = open(filename8,'a')
f.write(str(test2_ppv)+'\n')
f.close()

filename9='/results/Figure 5/combined_LPE/auc/test2.AUC_CI.txt'
f = open(filename9,'a')
