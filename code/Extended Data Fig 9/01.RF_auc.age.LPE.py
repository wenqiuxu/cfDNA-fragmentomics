...
#input feature
gene_list_file = pd.read_table("/data/Extended Data Fig 9/RF.age.features.txt", index_col=0, header = None)
...
f = open ('/results/Extended Data Fig 9/model_age.LPE.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Extended Data Fig 9/AUC_age.LPE.pdf'
#画图
plt.figure()
lw = 2
