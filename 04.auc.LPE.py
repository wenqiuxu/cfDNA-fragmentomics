...
gene_list_file_clinic = pd.read_table("/data/Extended Data Fig 9/RF.clinic.features.txt", index_col=0, header = None)
gene_list_clinic = gene_list_file_clinic.index.tolist()
gene_list_file_cfDNA = pd.read_table("/data/Extended Data Fig 6/RF.tss_coverage_gini.features.txt", index_col=0, header = None)
gene_list_cfDNA = gene_list_file_cfDNA.index.tolist()
gene_list_file_combined = pd.read_table("/data/Figure 5/RF_LPE.combined.features.txt", index_col=0, header = None)
...
##三个模型
res1 = open('/data/model_LPE/model_clinic.LPE.dat','rb')
s1=res1.read()
clf_clinic=pickle.loads(s1)

res2 = open('/data/model_LPE/tss_coverage_gini.dat','rb')
s2=res2.read()
clf_cfDNA=pickle.loads(s2)

res3 = open('/data/model_LPE/combined_LPE.dat','rb')
s3=res3.read()
clf_combined=pickle.loads(s3)

###plot AUC
filename1='/results/Figure 5/AUC_LPE.valid.pdf'
#画图
plt.figure()
lw = 2
...
###plot AUC
filename2='/results/Figure 5/AUC_LPE.test1.pdf'
#画图
plt.figure()
lw = 2
plt.figure(figsize=(5,5))
...
###plot AUC
filename2='/results/Figure 5/AUC_LPE.test2.pdf'
#画图
plt.figure()
lw = 2
plt.figure(figsize=(5,5))
