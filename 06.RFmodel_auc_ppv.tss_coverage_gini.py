...
#input feature
gene_list_file = pd.read_table("/data/Figure 4/RF.tss_coverage_gini.features.txt", index_col=0, header = None)
...
f = open ('/results/Figure 4/tss_coverage_gini/model/tss_coverage_gini.dat','wb')
pickle.dump(clf,f)
f.close()

###plot AUC
filename1='/results/Figure 4/tss_coverage_gini/auc/AUC_1.pdf'
#画图
plt.figure()
lw = 2
...
filename2='/results/Figure 4/tss_coverage_gini/ppv/train.PPV_CI.csv'
f = open(filename2,'a')
f.write(str(train_ppv)+'\n')
f.close()

filename3='/results/Figure 4/tss_coverage_gini/auc/train.AUC_CI.txt'
f = open(filename3,'a')
...
filename4='/results/Figure 4/tss_coverage_gini/ppv/val.PPV_CI.csv'
f = open(filename4,'a')
f.write(str(val_ppv)+'\n')
f.close()

filename5='/results/Figure 4/tss_coverage_gini/auc/val.AUC_CI.txt'
f = open(filename5,'a')
...
filename6='/results/Figure 4/tss_coverage_gini/ppv/test1.PPV_CI.csv'
f = open(filename6,'a')
f.write(str(test1_ppv)+'\n')
f.close()

filename7='/results/Figure 4/tss_coverage_gini/auc/test1.AUC_CI.txt'
f = open(filename7,'a')
...
filename8='/results/Figure 4/tss_coverage_gini/ppv/test2.PPV_CI.csv'
f = open(filename8,'a')
f.write(str(test2_ppv)+'\n')
f.close()

filename9='/results/Figure 4/tss_coverage_gini/auc/test2.AUC_CI.txt'
f = open(filename9,'a')
...
###plot AUC for depth
filename10='/results/Figure 4/tss_coverage_gini/auc/AUC_2.pdf'
#画图
plt.figure()
lw = 2
plt.figure(figsize=(5,5))
...
filename11='/results/Figure 4/tss_coverage_gini/ppv/test_10x.PPV_CI.csv'
f = open(filename11,'a')
f.write(str(test_10x_ppv)+'\n')
f.close()

filename12='/results/Figure 4/tss_coverage_gini/auc/test_10x.AUC_CI.txt'
f = open(filename12,'a')
...
filename13='/results/Figure 4/tss_coverage_gini/ppv/test_10_30x.PPV_CI.csv'
f = open(filename13,'a')
f.write(str(test_10_30x_ppv)+'\n')
f.close()

filename14='/results/Figure 4/tss_coverage_gini/auc/test_10_30x.AUC_CI.txt'
f = open(filename14,'a')
...
filename19='/results/Figure 4/tss_coverage_gini/ppv/test_30x.PPV_CI.csv'
f = open(filename19,'a')
f.write(str(test_30x_ppv)+'\n')
f.close()

filename20='/results/Figure 4/tss_coverage_gini/auc/test_30x.AUC_CI.txt'
f = open(filename20,'a')
